...
//fs.chmodSync(__dirname + "/ejemplo.txt", "666");
 ...
 * nombre del archivo sobre el que queremos trabajar. El segundo argumento es el contenido ¡Súper sencillo!
 */

if (fs.existsSync("./ejemplo.txt")) {
	//existsSync devuelve true si el archivo sí existe, y false si el archivo no existe
	...
	*/
	...
	//Esta vez el contenido será: '¡Hola, Coders, estoyt en un archivo! Más contenido' esto gracias al appendFileSync.
